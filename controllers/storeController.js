...
exports.resize = async (req, res, next) => {
  // check if there is no new to resize
  if(!req.file) {
...
exports.getStores = async (req, res) => {
  ...
  if(!stores.length && skip) {
    req.flash('info', 'The requested page doesn\'t exists');
...
exports.getStoresByTag = async (req, res) => {
  ...
  const tagQuery = tag || { $exists: true}; //It will show us every single store that has at least one tag on it
